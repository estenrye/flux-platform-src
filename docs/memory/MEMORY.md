...
- [Node GUA On-Link Reply Unreliable](node-gua-onlink-reply-unreliable.md) — root cause confirmed (VLAN-100 on-link reply drop, not GUA-specific); policy-routing fix VALIDATED on one node 2026-09-09 (4/6 success), DaemonSet build-out is docs/superpowers/plans/2026-09-09-vlan100-onlink-routing-daemonset.md Tasks 2-7
