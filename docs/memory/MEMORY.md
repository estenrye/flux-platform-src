...
- [Node GUA On-Link Reply Unreliable](node-gua-onlink-reply-unreliable.md) — DISPROVEN GUA-specific: any VLAN-100-resident client's traffic (GUA or ULA) to a fleet VIP drops mid-handshake; the ULA-VIP "fix" (PR #189-191) doesn't help real VLAN-100 consumers; blocks VLAN 179 final cutover, still unfixed
